...
class CarlaDataCollector:
    ...
    def __init__(self, host="127.0.0.1", port=2000, 
        ...
        self.observation = {key: None for key in ["rgb", "rgb_top","segmentation"]}        # Last received observations
        self.observation_buffer = {key: None for key in ["rgb","rgb_top", "segmentation"]}
        ...
        try:
            ...
            self.dashcam_rgb_top = Camera(self.world, out_width, out_height,
                                      transform=camera_transforms["roof"],
                                      attach_to=self.vehicle, on_recv_image=lambda e: self._set_observation_image("rgb_top", e))
    ...
    def step(self, action):
        ...
        self.observation["rgb_top"] = self._get_observation("rgb_top")
